        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (data.length == 2) {
                    ...
                    $.ajax({
                        url: 'http://' + ip + '/Slim_Proxy_okulsis/SlimProxyBoot.php?url=OdevListesiOgrenciveYakin_mbllogin&ogrenciID=' + value + '&egitimYilID=' + egitimyiliid + '&did=' + did + '&cid=' + cid + '&lid=' + lid + '',
                        type: 'GET',
                        dataType: 'json',
                        success: function (data) {
                            var j;
                ...
                $("#selectNumber").on('change', function () {
                    ...
                    $.ajax({
                        url: 'http://' + ip + '/Slim_Proxy_okulsis/SlimProxyBoot.php?url=OdevListesiOgrenciveYakin_mbllogin&ogrenciID=' + this.value + '&egitimYilID=' + egitimyiliid + '&did=' + did + '&cid=' + cid + '&lid=' + lid +'',
                        type: 'GET',
                        dataType: 'json',
                        success: function (data) {
