...
function load() {
    ...
    try {
        ...
        $.ajax({
            ...
            url: 'http://' + ip + '/Slim_Proxy_okulsis/SlimProxyBoot.php?url=OgretmenDersProgramiListesi_mbllogin&ogretmenID=' + kisiid + '&dersYiliID=' + dersyiliid + '&cid=' + cid + '&lid=' + lid + '&did=' + did + '&donemID=1',
            type: 'GET',
            dataType: 'json',
            success: function (data) {
                var j;
